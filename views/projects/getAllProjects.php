  ...
  <?php foreach ($allProject as $project) : ?>
    <div class="flex flex-col max-w-3xl gap-5 p-5 border mb-10 rounded-xl bg-white">
      <div class=" flex justify-between">
        ...
        <span>
          <a href="./index.php?viewofproject=updateProject&project=<?= $project['ID'] ?>"  class="block mb-7 font-inter w-fit  focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm text-blue-500 px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
           edit
          </a>
          <a href="./index.php?viewofproject=deleteProject&project=<?= $project['ID'] ?>"  class="block mb-7 font-inter w-fit  focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm text-blue-500 px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
           delete
          </a>
