    ...
    <section class= "hero-section">
        <div class="grid max-w-screen-xl mt-10 px-4 py-8  mx-auto lg:gap-0 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mx-auto lg:mx-auto place-self-center lg:col-span-7 w-auto">
                ...
                <a href="#" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-3xl bg-primary-600 hover:bg-primary-700 focus:ring-4">
                    <?php  echo "Hire Freelancers" ?>
                    <svg class="w-5 h-5 ml-2 -mr-1" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10.293 3.293a1 1 0 011.414 0l6 6a1 1 0 010 1.414l-6 6a1 1 0 01-1.414-1.414L14.586 11H3a1 1 0 110-2h11.586l-4.293-4.293a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                </a>
                <a href="#" class="inline-flex items-start justify-center mt-5 px-2 py-3 text-base text-left text-gray-900 border border-gray-300 rounded-3xl hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
    ...
    <section class="categories">
      <div class=" flex flex-col items-center py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
        ...
        <div class="grid gap-6 lg:gap-10 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 items-center">
          <div class="shadow-md">
            <a href="#" class="block w-full h-50 relative rounded-2xl overflow-hidden">
          ...
          <div class="shadow-md hidden sm:block">
            <a href="#" class="block w-full h-50 relative rounded-2xl overflow-hidden">
              <img class="w-full h-full" src="../images/category2.png" alt="Graphic Design">
                <div class="absolute inset-0 bg-black bg-opacity-50"></div>
                <div class="absolute inset-0 flex items-center justify-center">
          ...
          <div class="shadow-md hidden sm:block">
            <a href="#" class="block w-full h-50 relative rounded-2xl overflow-hidden">
              <img class="w-full h-full" src="../images/category3.png" alt="Graphic Design">
                <div class="absolute inset-0 bg-black bg-opacity-50"></div>
                <div class="absolute inset-0 flex items-center justify-center">
          ...
          <div class="shadow-md">
            <a href="#" class="block w-full h-50 relative rounded-2xl overflow-hidden">
              <img class="w-full h-full " src="../images/category4.png" alt="Graphic Design">
                <div class="absolute inset-0 bg-black bg-opacity-50"></div>
                <div class="absolute inset-0 flex items-center justify-center">
